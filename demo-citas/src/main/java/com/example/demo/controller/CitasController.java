...
public class CitasController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Citas> getCitasById(@PathVariable("id") Integer id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Citas> updateCitas(@PathVariable("id") int id, @RequestBody Citas citas) {
        citas.setId(id);
    ...
    // Eliminar una cita
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCitas(@PathVariable("id") int id) {
